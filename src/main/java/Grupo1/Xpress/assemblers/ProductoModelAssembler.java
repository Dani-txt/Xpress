...
public class ProductoModelAssembler implements RepresentationModelAssembler<Producto, EntityModel<Producto>>{
  ...
  public EntityModel<Producto> toModel(Producto producto) {
    return EntityModel.of(producto,
        ...
        linkTo(methodOn(ProductoControllerV2.class).getByMarca(producto.getMarca().getNombre())).withRel("productos-misma-marca"),
        linkTo(methodOn(ProductoControllerV2.class).getByCategoria(producto.getCategoriaProducto().getNombre())).withRel("productos-misma-categoria")
    );
  }
}
